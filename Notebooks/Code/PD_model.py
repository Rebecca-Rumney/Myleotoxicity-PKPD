...
import pints
from Code.PK_model import solve_2_comp
...
class PintsPDFribergLinE(pints.ForwardModel):
    def __init__(
        self, PK_params, dose, fix_param=None, num_comp=2, start_time=None
    ):
    ...
    def simulate(self, parameter, times):
        ...
        curve = PD_friberg_result(self._dose, self._num_comp, all_params, times)[:,-1]
